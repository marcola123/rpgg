...
public class ServerButton : MonoBehaviour
{
    ...
    private AuthManager.ServerData serverData;
    private Action<AuthManager.ServerData> onSelectCallback;

    public void Setup(AuthManager.ServerData data, Action<AuthManager.ServerData> onSelect)
    {
        serverData = data;
